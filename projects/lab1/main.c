...
void main()
{
  ...
  GrStringDraw(&sContext, "Laboratory 1", -1, 6, 60, true);
  GrStringDraw(&sContext, "Duty = 50%", -1, 42, 70, true);
...
void calc(){
  ...
  cfaf128x128x16Clear();
  GrStringDraw(&sContext, "Laboratory 1", -1, 6, 60, true);
  int val = (int)(duty*100);
  switch(val){
  case 10:
      GrStringDraw(&sContext, "Duty = 10%", -1, 42, 70, true);
      break;
  case 20:
      GrStringDraw(&sContext, "Duty = 20%", -1, 42, 70, true);
      break;
  case 30:
      GrStringDraw(&sContext, "Duty = 30%", -1, 42, 70, true);
      break;
  case 40:
      GrStringDraw(&sContext, "Duty = 40%", -1, 42, 70, true);
      break;
  case 50:
      GrStringDraw(&sContext, "Duty = 50%", -1, 42, 70, true);
      break;
  case 60:
      GrStringDraw(&sContext, "Duty = 60%", -1, 42, 70, true);
      break;
  case 70:
      GrStringDraw(&sContext, "Duty = 70%", -1, 42, 70, true);
      break;
  case 80:
      GrStringDraw(&sContext, "Duty = 80%", -1, 42, 70, true);
      break;
  case 90:
      GrStringDraw(&sContext, "Duty = 90%", -1, 42, 70, true);
      break;
  case 100:
      GrStringDraw(&sContext, "Duty = 100%", -1, 42, 70, true);
      break;
  }
}
