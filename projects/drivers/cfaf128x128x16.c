...
// Modified by Luís Henrique Beltrão Santana (20. April 2020)
//
//*****************************************************************************
...
//*****************************************************************************
  ...
  #define DISPLAY_SSI_GPIO_PERIPH     SYSCTL_PERIPH_GPIOQ
  #define DISPLAY_FSS_GPIO_PERIPH     SYSCTL_PERIPH_GPIOF
  #define DISPLAY_C_D_GPIO_PERIPH     SYSCTL_PERIPH_GPIOK
  #define DISPLAY_CS_GPIO_PERIPH      SYSCTL_PERIPH_GPIOP
...
#else
  #define DISPLAY_PINCFG_SSICLK     GPIO_PQ0_SSI3CLK
  #define DISPLAY_PINCFG_SSIFSS     GPIO_PF2_SSI3FSS
  #define DISPLAY_PINCFG_SSITX      GPIO_PQ2_SSI3XDAT0
  #define DISPLAY_PINCFG_SSIRX      GPIO_PQ3_SSI3XDAT1
#endif
...
#else
  #define DISPLAY_SSI_PORT          GPIO_PORTQ_BASE
  #define DISPLAY_SSI_PORT_FSS      GPIO_PORTF_BASE
  #define DISPLAY_SSI_PIN_CLK       GPIO_PIN_0
  #define DISPLAY_SSI_PIN_FSS       GPIO_PIN_2
  #define DISPLAY_SSI_PIN_TX         GPIO_PIN_2
  #define DISPLAY_SSI_PIN_RX        GPIO_PIN_3
  #define DISPLAY_SSI_PINS         (DISPLAY_SSI_PIN_CLK |  \
                                    DISPLAY_SSI_PIN_TX | DISPLAY_SSI_PIN_RX)
  #define DISPLAY_SSI_PINS_FSS     DISPLAY_SSI_PIN_FSS
#endif
...
#else
  #define DISPLAY_D_C_PORT          GPIO_PORTK_BASE
...
#else
  #define DISPLAY_CS_PORT           GPIO_PORTP_BASE
...
#if BOOSTER_PACK_SLOT == 2
  SysCtlPeripheralEnable(DISPLAY_FSS_GPIO_PERIPH);
#endif
...
#if BOOSTER_PACK_SLOT == 2
  delay(100);
  GPIOPinTypeSSI(DISPLAY_SSI_PORT_FSS, DISPLAY_SSI_PINS_FSS);
#endif
